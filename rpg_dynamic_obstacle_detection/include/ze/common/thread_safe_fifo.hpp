 ...
 **/
template <class T, unsigned Capacity, bool Erase = true,
...
ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::ThreadSafeFifo()
    : mutex_(), read_cond_(), write_cond_(), buf_(), tail_(0), head_(0) {}
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::empty(
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::full(
    UniqueLock &lock) const {
  return _full();
}
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
unsigned ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::size(
    UniqueLock &lock) const {
  return _size();
}
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
void ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::write(
    const T &data, UniqueLock &lock) {
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::nonBlockingWrite(
    const T &data) {
  UniqueLock lock(mutex_);
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::timedWrite(
    const T &data, unsigned timeout) {
  UniqueLock lock(mutex_);
...
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::timedWrite(
    const T &data, unsigned timeout, UniqueLock &lock) {
...
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::timedWrite(
    T &&data, unsigned timeout, UniqueLock &lock) {
  if (!write_cond_.wait_for(lock, std::chrono::milliseconds(timeout),
                            [this] { return _notFull(); })) {
    return false;
  }
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::nonBlockingRead(
    T &data) {
  UniqueLock lock(mutex_);
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
bool ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::timedRead(
    T &data, unsigned timeout) {
  UniqueLock lock(mutex_);
...
//------------------------------------------------------------------------------
template <typename T, unsigned Capacity, bool Erase, bool MoveSemantics>
unsigned ThreadSafeFifo<T, Capacity, Erase, MoveSemantics>::_nextIndex(
